...
test('expand directive @update', async () => {
...
test('@update error case 1', async () => {
  const schema = await importDefaults({
...
test('@update error case 2', async () => {
  const schema = await importDefaults({
...
test('@update error case 3', async () => {
  const schema = await importDefaults({
    initial: () => import('./fixtures/errors/x3.gql?raw'),
  })
